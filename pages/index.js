      ...
      <main className="main">
        <h1 className="title">
          ...
          <span className="titleColor">
            <b style={{paddingLeft: "20px", color: "red"}}>Thoughtforms.ai</b>
          </span>
        </h1>
        <p className="description">
          <input id="prompt" type="text" value={prompt} onChange={(e) => setPrompt(e.target.value)} placeholder="Enter your query" />
          <input id="number" type="text" value={number} onChange={(e) => setNumber(e.target.value)} placeholder="Enter the number of images" max="10" />
